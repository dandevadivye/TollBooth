...
namespace TollBooth
{
    public class FindLicensePlateText
    {
        ...
        private async Task<string> MakeOCRRequest(byte[] imageBytes)
        {
            ...
            var uriBase = Environment.GetEnvironmentVariable("https://westus.api.cognitive.microsoft.com/");
            var apiKey = Environment.GetEnvironmentVariable("bb9e41cb0aa74a709392a7f145159a87");
